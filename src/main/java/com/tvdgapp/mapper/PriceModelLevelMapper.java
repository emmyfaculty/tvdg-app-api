...
//    }
    ...
    PriceModelLevelMapper INSTANCE = Mappers.getMapper(PriceModelLevelMapper.class);

    CreatePriceModelLevelDto toDTO(PriceModelLevel pricing);

    PriceModelLevel toEntity(CreatePriceModelLevelDto pricingDTO);
}
