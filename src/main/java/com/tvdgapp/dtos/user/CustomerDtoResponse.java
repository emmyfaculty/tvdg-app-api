...
public class CustomerDtoResponse {
    ...
    public CustomerDtoResponse(String title, String companyName, String companyContactName, String companyEmail, String companyPhoneNo, String companyRegNumber, String designation,
                           String address, String city, String state, String postalCode, String industry, String dateOfBirth, String natureOfBusiness, CustomerType customerType, Integer pricingLevelId) {
        this.title = title;
