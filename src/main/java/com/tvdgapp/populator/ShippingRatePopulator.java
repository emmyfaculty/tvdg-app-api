...
import com.tvdgapp.dtos.shipment.ShippingRateRequestDto;
...
public class ShippingRatePopulator extends AbstractDataPopulator<ShippingRateRequestDto, Shipment>  {
    ...
    public ShippingRatePopulator(CustomerUserRepository repository, PackageCategoryRepository packageCategoryRepository, SenderDetailsService senderDetailsService, ReceiverDetailsService receiverDetailsService,
                                 ShipmentRepository shipmentRepository, ShippingServiceRepository shippingServiceRepository, ServicePortfolioService servicePortfolioService, CustomerShipmentMapRepository customerShipmentMapRepository) {
    ...
    @Override
    public Shipment populate(ShippingRateRequestDto source, Shipment target) {
...
//        double totalShipmentAmount = baseCost + vat + packagingFee + totalCategoryDocumentAmount;
        ...
        if (source.isInsurance()) {
            ...
            totalShipmentAmount.add(insuranceFee); //+= insuranceFee;
