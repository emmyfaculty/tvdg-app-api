...
public class MySecurityExpressionRoot implements MethodSecurityExpressionOperations {
    ...
    @Override
    public final boolean hasAuthority(String permission) {
        ...
        if(permissions.contains(Constants.ROLE_SUPER_ADMIN) || permissions.contains(permission)){
            return true;
        }
        return false;
    }
   ...
   /* public boolean isMember(Long OrganizationId) {
    ...
    public final boolean hasAnyAuthority(String... authorities) {
        ...
        var grantedAuthorities = authentication.getAuthorities();
        grantedAuthorities.forEach(authority -> {
            permissionsSet.add(authority.getAuthority());
        });

        if(permissionsSet.contains(Constants.ROLE_SUPER_ADMIN)){
            return true;
        }
