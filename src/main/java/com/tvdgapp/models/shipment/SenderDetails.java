...
import static com.tvdgapp.constants.SchemaConstant.TABLE_SENDER_DETAILS;
...
@SQLDelete(sql = "UPDATE sender_details SET deleted = '1' WHERE id = ?")
@Where(clause = "deleted='0'")
@Table(name = TABLE_SENDER_DETAILS)
public class SenderDetails extends TvdgAppEntity<Long, SenderDetails> implements Auditable {
