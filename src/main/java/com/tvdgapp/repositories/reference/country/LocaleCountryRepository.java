...
public interface LocaleCountryRepository extends JpaRepository<LocaleCountry, Integer> {
    ...
    @Query("select new com.tvdgapp.models.reference.countrycode.LocaleCountryDto(s.id, s.countryName, s.iso3, s.iso2, s.phonecode, s.capital, s.currency, s.flag, s.wikiDataId) from LocaleCountry s ")
