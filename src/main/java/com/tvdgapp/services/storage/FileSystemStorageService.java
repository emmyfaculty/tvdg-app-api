package com.tvdgapp.services.storage;

import com.tvdgapp.config.FileStorageProperties;
import com.tvdgapp.exceptions.FileStorageException;
import com.tvdgapp.utils.FilePathUtils;
import com.tvdgapp.utils.FileUtil;
...
public class FileSystemStorageService implements FileStorageService {
    ...
    @Override
    public @Nullable byte[] getFileContent(String filenamePath) {
        byte[] content = null;
    ...
    private String buildLocalPath(String path) {
        String builder = fileStorageProperties.getUploadDir() + File.separator +
                workingDir +
                File.separator +
                path;
        return builder;
